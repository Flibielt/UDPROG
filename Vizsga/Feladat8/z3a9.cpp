...
//		regi.gyoker = nullptr;
    ...
    */
    ...
    ///A bejárásokhoz egyszerűbb meghívás, úgy mint a kiírásnál
    void preorder(void)
    {
...
private:
    ...
    */
    ...
    ///A bejáráshoz a függvények
    void preorder(Csomopont * elem);
    void inorder(Csomopont * elem);
    void postorder(Csomopont * elem);
...
void LZWBinFa::preorder(LZWBinFa::Csomopont* elem)
{
	if (elem != NULL)
	{
		std::cout << elem->getBetu() << " ";
		preorder(elem->nullasGyermek());
		preorder(elem->egyesGyermek());
	}
}

void LZWBinFa::inorder(LZWBinFa::Csomopont* elem)
{
	if (elem != NULL)
	{
		inorder(elem->nullasGyermek());
		std::cout << elem->getBetu() << " ";
		inorder(elem->egyesGyermek());
	}
}

void LZWBinFa::postorder(LZWBinFa::Csomopont* elem)
{
	if (elem != NULL)
	{
		postorder(elem->nullasGyermek());
		postorder(elem->egyesGyermek());
		std::cout << elem->getBetu() << " ";
	}
}
...
ostream& operator<<(ostream& os,  vector<LZWBinFa>& v)
{
    ...
    */
	...
	std::cout << "depth = " << it -> getMelyseg () << std::endl;
    std::cout << "mean = " << it -> getAtlag () << std::endl;
    std::cout << "var = " << it -> getSzoras () << std::endl;
    }
    return os;
}
/*
...
int main ( int argc, char *argv[] ) {
    ...
    */
    ...
    std::cout << "Push_back előtt\n";
    v.push_back(binFa);
    std::cout << "Push_back után\n";

    std::cout << v;

    std::cout << "Fa bejárások:\n";
    binFa.preorder();
    binFa.inorder();
    binFa.postorder();
    
    //Kiírás a fájlba
    std::fstream kiFile ("ki.txt", std::ios_base::out);
    
    kiFile << "Mélység: " << binFa.getMelyseg() << std::endl;
    kiFile << "Átlag: " << binFa.getAtlag() << std::endl;
    kiFile << "Szórás: " << binFa.getSzoras() << std::endl << std::endl;
    kiFile << binFa;
