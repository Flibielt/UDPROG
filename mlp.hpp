...
public:
  Perceptron ( int nof, ... )
  {
    ...
    for ( int i {0}; i < n_layers; ++i )
      {
        ...
        //if ( i )
          ...
          /*
          size_out2 += sizeof(double)*n_units[i];
          size_out += sizeof(double)*n_units[i];
          */
          
          //std::cout << "n_units[0]: " << n_units[0] << std::endl;
      }
      for ( int i = 0; i < n_layers; i++)
      {
    ...
    /*
    size_out2 += sizeof(double**)*(n_layers-1);
    size_out += sizeof(double**)*(n_layers-1);
    */
    ...
    for ( int i {1}; i < n_layers; ++i )
      ...
      //std::cout << "size_out: " << size_out / 1024 / 1024 << std::endl;
      //std::cout << "size_out2: " << size_out2 / 1024 / 1024 << std::endl;
  }
  ...
  double operator() ( double image [] )
  {
    ...
    std::cout << "return: " << sigmoid (units[n_layers - 1][0]) << std::endl;
